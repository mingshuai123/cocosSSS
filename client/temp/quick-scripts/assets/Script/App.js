...
cc._RF.push(module, 'dc8e38V1IJIopyxp5hHb3FV', 'App', __filename);
// Script/App.js
...
var Global = cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        http.sendHall({ method: "game.cfg", ver: cc.ver }, function (resp) {
        ...
        var sssNetMgr = require("./sss/sssNetMgr");
        ...
        var getScreenShotImagePath = function getScreenShotImagePath() {
        ...
        cc.screenShoot = function (func) {
            ...
            var fileName = 'fnyl-' + new Date().valueOf() + '.png';
