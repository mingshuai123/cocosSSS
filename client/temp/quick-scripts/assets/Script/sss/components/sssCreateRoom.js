(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/sss/components/sssCreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '530a73PwDtKJZhsWot1MyJe', 'sssCreateRoom', __filename);
// Script/sss/components/sssCreateRoom.js
    ...
    createRoom: function createRoom() {
        ...
        var onCreate = function onCreate(ret) {
            if (ret.errcode !== 0) {
                ...
                //     cc.vv.net.close();
                //     cc.emitter.on('disconnect', function(){
                //         cc.sssNetMgr.connectGameServer(ret);
