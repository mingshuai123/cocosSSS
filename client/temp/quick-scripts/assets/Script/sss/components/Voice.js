(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/sss/components/Voice.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f6db9z0CxdEzpRVgU569dDu', 'Voice', __filename);
// Script/sss/components/Voice.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        var btnOk = cc.find("Canvas/voice/voice_failed/btn_ok");
        if (btnOk) {
            cc.vv.utils.addClickEvent(btnOk, this.node, "Voice", "onBtnOKClicked");
        }
        ...
        if (btnVoice) {
            ...
            btnVoice.on(cc.Node.EventType.TOUCH_END, function () {
                ...
                if (Date.now() - self._lastTouchTime < 1000) {
                    ...
                    cc.vv.voiceMgr.stopRecord("cancel");
                } else {
                    self.onVoiceOK();
                }
    ...
    onVoiceOK: function onVoiceOK() {
        if (this._lastTouchTime != null) {
            cc.vv.voiceMgr.stopRecord("release");
            cc.vv.voiceMgr._Time = Date.now() - this._lastTouchTime;
            //var msg = cc.vv.voiceMgr.getVoiceData("record.amr");

            /*var gameType = cc.vv.userMgr.serverType;
            if ('MJ_SERVER_TYPE' === gameType) {
                cc.vv.net.send("voice_msg",{msg:msg,time:time});
            }
            else{
                cc.sssNet.send("voice_msg",{msg:msg,time:time});
            }*/
        }
        this._voice.active = false;
    },
