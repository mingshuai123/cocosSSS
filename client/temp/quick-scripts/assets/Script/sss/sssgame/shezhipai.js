(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/sss/sssgame/shezhipai.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '22c59GobSNPq5he7Lwg7Qh4', 'shezhipai', __filename);
// Script/sss/sssgame/shezhipai.js
...
cc.Class({
    ...
    onBtnOk: function onBtnOk() {
        ...
        cc.log(arrZDType);
        cc.log(arrWDType);
        if (cc.sssNetMgr.conf.type == 3) {
            if (arrZDType[0] == 8 && arrWDType[0] == 9) {
                if (arrTDType[0] > arrZDType[0]) {
                    //不可以出牌
                    cc.scene.onShowTips("提示", "必须要头道小于中道小于尾道");
        ...
        if (arrTDType[0] == arrZDType[0]) {
            if (arrTDType[0] == 1) {
                ...
                if (Number(tdMax.value) > Number(zdMax.value)) {
                    return;
                }
            }
        ...
        data.push(zdArr);
        data.push(wdArr);
        window.sssGame.outpaidata = data;
        cc.sssNet.send('compare', data);
        this.reset();
    },
    ...
    onBtnQuickSwing: function onBtnQuickSwing() {
        cc.sssNet.send('quick_swing_request');
    },
    ...
    compareSameType: function compareSameType(arrPai1, arrPai2, type) {
        if (type === 6) {
            ...
            for (var _i3 = 0; _i3 < arrPai1.length; _i3++) {
                if (Number(arrPai1[_i3].value) > Number(arrPai2[_i3].value)) {
                    return 1;
                } else if (Number(arrPai1[_i3].value) < Number(arrPai2[_i3].value)) {
                    return -1;
                }
            }
            return 0;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=shezhipai.js.map
