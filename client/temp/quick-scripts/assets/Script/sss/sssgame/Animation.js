(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/sss/sssgame/Animation.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '12748lZn19A8IPO+1gEQQUe', 'Animation', __filename);
// Script/sss/sssgame/Animation.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        this.tiezhi = this.node.getChildByName('tiezhi');
        ...
        this.bxgh = this.node.getChildByName('baxianguohai');
        this.qxgz = this.node.getChildByName('qixinggaozhao');
        this.llds = this.node.getChildByName('liuliudashun');
