(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/sss/ReplayMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1a6a1p86NFL6KZEZCnbu7tt', 'ReplayMgr', __filename);
// Script/sss/ReplayMgr.js
...
cc.Class({
    ...
    SSPgetNextAction: function SSPgetNextAction() {
    ...
    isSSPpai: function isSSPpai(data) {
        //下一张是不是牌
        var isPai = false;
        if (data.T >= 0) {
            isPai = true;
    ...
    SSPtakeAction: function SSPtakeAction() {
        ...
        var typeofAction = _typeof(action.type);
        var tempType = -1;
        ...
        if (tempType === ACTION_CHUPAI) {
            //出牌
            cc.vv.sspNetMgr.doChupai(action.si, action.pai);
            return 3.0;
        } else if (tempType === ACTION_GUO) {
            //过
            var seats = cc.vv.sspNetMgr.seats;
            var PlaneLen = 0; //游戏人数
            for (var i = 0; i < seats.length; ++i) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ReplayMgr.js.map
