(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/AnysdkMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bb957ycYIZHrb31nqijuSsK', 'AnysdkMgr', __filename);
// Script/AnysdkMgr.js
...
cc.Class({
    ...
    //     setTimeout(fn,50);
    // },
    shareResult: function shareResult(to) {
        if (this._isCapturing) {
            return;
        }
        this._isCapturing = true;
    ...
    //分享url事件
    shareUrlEvent: function shareUrlEvent(to) {
    ...
    */
    ...
    onLoginResp: function onLoginResp(data) {
    ...
    shareImg: function shareImg(imgPath, to) {
        console.log('分享图片: ');
        var agent = anysdk.agentManager;
        this.share_plugin = agent.getSharePlugin();
        this.share_plugin.setListener(this.onShareResult, this);
    ...
    getAccess_token: function getAccess_token(desc, roomid) {
        //获取签名
        this.jquery = window.jQuery;
        var self = this;
        var fn = function fn(ret) {
    ...
    token: function token(isgetToken, desc, roomid) {
        var self = this;
    ...
    getsignature: function getsignature(access_token, desc, roomid) {
        var self = this;
    ...
    H5share: function H5share(desc, imgUrl, roomid) {
        ...
        jssdk.addEventListener('load', function () {
            wx.config({
                ...
                jsApiList: ['checkJsApi', 'onMenuShareTimeline', //分享到朋友圈
...
cc._RF.pop();
        ...
        //# sourceMappingURL=AnysdkMgr.js.map
