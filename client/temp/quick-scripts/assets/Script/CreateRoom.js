(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/CreateRoom.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b9019RowfNCtovy+MISzqRM', 'CreateRoom', __filename);
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        var toggle = this.mode == "fzmj" ? this.btn_fzmj : this.mode == "ndmj" ? this.btn_ndmj : this.btn_sss;
        toggle.getComponent(cc.Toggle).check();
    },

    onToggle: function onToggle(e, mode) {
        this.mode = mode;
    ...
    refresh_fangka: function refresh_fangka(fangka) {
        this.node.getChildByName("fangka").getComponent(cc.Label).string = fangka;
    },
    onCreateRoom: function onCreateRoom() {
        var option = this.room_option.getComponent("RoomOption").getOptions();
        cc.log(option);
        ...
        if (option.mj == "sss") {
            ...
            // console.log(data);
            cc.sssHttp.sendRequest("/create_private_room", data, function (ret) {
                console.log(ret);
                if (ret.errcode !== 0) {
                    if (ret.errcode == 2222) {
            ...
            http.sendHall({ method: "create_room", club_id: cc.cur_club ? cc.cur_club.club_id : 0, num: option.max_role, mode: this.mode, option: JSON.stringify(option) }, function (resp) {
                if (!resp.errno) {
                    ...
                    var content = CREATE_ERROR[resp.errno];
                    if (!content) {
    ...
    room_type: function room_type() {
        return cc.cur_club ? cc.cur_club.club_type : "PERSONAL";
    },
    defauleMode: function defauleMode() {
        var mode = cc.sys.localStorage.getItem("default_mj");
