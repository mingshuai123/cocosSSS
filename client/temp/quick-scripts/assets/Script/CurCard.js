(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/CurCard.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '792e5LwWRhAI7Ku00LEYnRC', 'CurCard', __filename);
// Script/CurCard.js
...
cc.Class({
    ...
    init: function init(dir, type, value, jin, mjgame) {
        this.dir = dir;
        this.type = type;
        this.value = value;
        this.laizi = jin;
        ...
        var sprite_name = 'p' + dir + (dir == 4 ? 'b' : 's') + type + '_' + value + ext;
        if (type == 4 && value > 7) {
    ...
    select: function select(event) {
        ...
        if (this.selected) {
            ...
            http.sendGame({ method: "discard", type: this.type, value: this.value }, function (resp) {});
    ...
    stop_move: function stop_move(event) {
        if (this.unable_handle()) {
            return;
        }
        if (!this.out_card) {
    ...
    unable_handle: function unable_handle() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=CurCard.js.map
